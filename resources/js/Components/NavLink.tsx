...
export default function NavLink({
    ...
    return (
        <Link
            {...props}
            className={
                "inline-flex items-center justify-center text-center text-nowrap py-3 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none " +
                (active
